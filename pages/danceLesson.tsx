...
const IndexPage: React.FC<IndexPageProps> = ({ webSettings, latestNews, faq }) => {
  ...
  const localePath = locale === 'en' ? 'en/danceLesson' : 'danceLesson';
  ...
  return (
    <div>
      <Head>
        ...
        <link
          rel="alternate"
          href={`${HOME_PATH}danceLesson`}
          hrefLang="zh-hk"
        />
        <link
          rel="alternate"
          href={`${HOME_PATH}en/danceLesson`}
          hrefLang="en-hk"
        />
        <link
          rel="canonical"
...
export const getStaticProps: GetStaticProps = async ({ locale }) => {
  ...
  try {
    ...
    const dancePage = await contentfulService.getEntriesByContentType('danceLessons', locale);
