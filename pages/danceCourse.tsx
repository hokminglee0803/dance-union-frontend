...
const IndexPage: React.FC<IndexPageProps> = ({ webSettings, latestNews, faq }) => {
  ...
  const localePath = locale === 'en' ? 'en/danceCourse' : 'danceCourse';
  ...
  return (
    <div>
      <Head>
        ...
        <link
          rel="alternate"
          href={`${HOME_PATH}danceCourse`}
          hrefLang="zh-hk"
        />
        <link
          rel="alternate"
          href={`${HOME_PATH}en/danceCourse`}
          hrefLang="en-hk"
        />
        <link
          rel="canonical"
...
export const getStaticProps: GetStaticProps = async ({ locale }) => {
  ...
  try {
    ...
    const dancePage = await contentfulService.getEntriesByContentType('danceCourse', locale);
