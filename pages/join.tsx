...
const Join: React.FC<JoinProps> = ({ generalInfo, knowMore, webSettings, latestNews }) => {
    ...
    const localePath = locale === 'en' ? 'en/join' : 'join';
    ...
    return (
        <div>
            <Head>
                ...
                <meta name="google-site-verification" content="Xj24ARH2mUnvhluOalhwzKKZfmd7l6DUR-asS6v-s-o" /> <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1"></meta>
