...
export const getStaticProps: GetStaticProps = async ({ locale }) => {
    ...
    try {
        ...
        for (let index = 0; index < showPage[0].fields.faq.fields.contents.length; index++) {
            const faqContent = showPage[0].fields.faq.fields.contents[index]
        ...
        for (let index = 0; index < showPage[0].fields.faq.fields.faq.length; index++) {
            const faqQuestion = showPage[0].fields.faq.fields.faq[index]
